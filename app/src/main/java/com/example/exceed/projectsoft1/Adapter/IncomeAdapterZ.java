 ...
 */
public class IncomeAdapterZ extends RecyclerView.Adapter<IncomeAdapterZ.ViewHolder> implements Serializable{
    private ViewHolder viewHolder;
    OnItemClickListener mItemClickListener;
    private List<Income> incomeDate;

    public IncomeAdapterZ(Tag tag){
