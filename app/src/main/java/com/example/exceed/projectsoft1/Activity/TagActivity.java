...
import com.example.exceed.projectsoft1.Adapter.TagAdapter;
...
//    private GoogleApiClient client;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        incomeAdapter = new TagAdapter("income");
        IrecList.setHasFixedSize(true);
        ...
        expenseAdapter = new TagAdapter("expense");
        ErecList.setHasFixedSize(true);
...
//    }
    private void addIncomeTag(final View v) {
        ...
        builder.setPositiveButton("Create", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (!nameText.getText().toString().equals("")) {
                    Storage.getInstance().addIncomeTag(new Tag(nameText.getText().toString(), red[0], green[0], blue[0]));
                    IrecList.setAdapter(incomeAdapter);
                    red[0] = 0;
                    green[0] = 0;
                    blue[0] = 0;
    ...
    private void addExpenseTag(final View v) {
        ...
        builder.setPositiveButton("Create", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (!nameText.getText().toString().equals("")) {
                    Storage.getInstance().addExpenseTag(new Tag(nameText.getText().toString(), red[0], green[0], blue[0]));
                    ErecList.setAdapter(expenseAdapter);
                    red[0] = 0;
                    green[0] = 0;
                    blue[0] = 0;
